...
** Note the actual steps have been included from the rust example
...
```
 ...
 ### Step 3: Deploy `basic_dao` with initial test accounts. ** Note: added canister name for Motoko at en d of deploy command **
...
### Step 4: List accounts and confirm you see 2 accounts

```
$ dfx canister call basic_dao list_accounts '()'
```

 ### Optional: Run the ic-repl test scripts:
